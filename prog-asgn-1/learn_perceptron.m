...
% If the output unit is correct, leave the weight alone.
% if the output unit incorrectly output a zero, add the input vector to the weight vector.
% if the output unit incorrectly output a one, subtract the input vector to the weight vector.
